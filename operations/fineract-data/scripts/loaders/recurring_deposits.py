#!/usr/bin/env python3
"""Fineract RecurringDeposits Loader"""
import sys
...
class RecurringDepositsLoader(BaseLoader):
    def __init__(self, yaml_dir: str, fineract_url: str, tenant: str = 'default'):
        super().__init__(yaml_dir, fineract_url, tenant)
        self.entity_type = 'RecurringDeposit'
        self.api_endpoint = '/recurringdepositaccounts'
...
def main():
    ...
    loader = RecurringDepositsLoader(args.yaml_dir, args.fineract_url, args.tenant)
