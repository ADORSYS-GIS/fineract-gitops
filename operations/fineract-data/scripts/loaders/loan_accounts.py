    ...
    def entity_exists(self, api_data: Dict[str, Any], yaml_data: Dict[str, Any]) -> Optional[int]:
        ...
        if spec.get('externalId'):
            try:
                ...
                logger.warning(f"Error checking existing loan accounts: {e}")
        return None

    def load_all(self) -> Dict[str, Any]:
        """Load all loan account YAML files"""
        logger.info("=" * 80)
...
def main():
    ...
    loader = LoanAccountsLoader(args.yaml_dir, args.fineract_url, args.tenant)
