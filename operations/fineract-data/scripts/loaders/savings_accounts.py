#!/usr/bin/env python3
"""Fineract SavingsAccounts Loader"""
import sys
...
def main():
    ...
    loader = SavingsAccountsLoader(args.yaml_dir, args.fineract_url, args.tenant)
