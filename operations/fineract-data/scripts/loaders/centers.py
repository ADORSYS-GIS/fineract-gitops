    ...
    def entity_exists(self, api_data: Dict[str, Any], yaml_data: Dict[str, Any]) -> Optional[int]:
        ...
        if spec.get('externalId'):
            try:
                ...
                logger.warning(f"Error checking existing centers: {e}")
        ...
        try:
            ...
            logger.warning(f"Error checking existing centers by name: {e}")

        return None

    def load_all(self) -> Dict[str, Any]:
        """Load all center YAML files"""
        logger.info("=" * 80)
...
def main():
    ...
    loader = CentersLoader(args.yaml_dir, args.fineract_url, args.tenant)
