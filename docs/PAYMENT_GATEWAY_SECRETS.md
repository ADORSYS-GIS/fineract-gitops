...
This document describes how to create and manage secrets for the Payment Gateway Service, which integrates with MTN MoMo and Orange Money payment providers.
